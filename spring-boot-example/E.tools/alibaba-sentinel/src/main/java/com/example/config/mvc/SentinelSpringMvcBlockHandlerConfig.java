...
import com.example.vo.ResultWrapper;
...
/**
 * Spring configuration for global exception handler. This will be activated when the {@code
 * BlockExceptionHandler} throws {@link BlockException directly}.
 *
 * @author kaizi2009
 */
@ControllerAdvice
