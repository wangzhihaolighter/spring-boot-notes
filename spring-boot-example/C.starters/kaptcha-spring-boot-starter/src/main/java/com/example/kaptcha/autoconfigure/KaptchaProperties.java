...
public class KaptchaProperties {
  ...
  /** 会话 */
  @NestedConfigurationProperty private Session session = new Session();

  /** 边框 */
  @NestedConfigurationProperty private Border border = new Border();

  /** 干扰 */
  @NestedConfigurationProperty private Noise noise = new Noise();

  /** 图片样式 */
  @NestedConfigurationProperty private Obscurificator obscurificator = new Obscurificator();

  /** 图片生产 */
  @NestedConfigurationProperty private Producer producer = new Producer();

  /** 文本生产 */
  @NestedConfigurationProperty private TextProducer textProducer = new TextProducer();

  /** 文字渲染器 */
  @NestedConfigurationProperty private WordRenderer wordRenderer = new WordRenderer();

  /** 背景 */
  @NestedConfigurationProperty private Background background = new Background();

  /** 图片 */
  @NestedConfigurationProperty private Image image = new Image();
  ...
  static class Obscurificator {
    /**
     * 实现类 水纹 {@link com.google.code.kaptcha.impl.WaterRipple} 鱼眼 {@link
     * com.google.code.kaptcha.impl.FishEyeGimpy} 阴影 {@link
